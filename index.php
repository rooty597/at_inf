              ...
              <div class="row">
                <div class="col-md-5 offset-md-1 ">
                  <div class="detail-box mt-5" >
                    <h1>
                      You CAN <br>
                      TAKE FREE PERSONALITY TESTS  <br>
                      HERE
		    </h1>

                    <p>
                  Discover who you are — one question at a time.
                    </p>
                    <div class="btn-box">
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <div class="detail-box">
            ...
            <p>
         Mindscape offers science-backed psychology tests to help you better understand your mind, emotions, and behavior. Discover insights, grow personally, and explore the landscape of who you are.   </p>
            <div class="btn-box">
              <a href="about.html" class="btn-1">
                Read More
              </a>
              <a href="signup.php" class="btn-2">
                Signup
              </a>
            </div>
          </div>
  ...
  <footer class="container-fluid footer_section ">
    <div class="container">
      <p>
       ...
       Danoiu Fernando & Ilie Andrei Cristian      </p>
